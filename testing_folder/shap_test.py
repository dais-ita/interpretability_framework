...
####SHAP
source = "train"
train_x, train_y = dataset_tool.GetBatch(batch_size = 128,even_examples=True, y_labels_to_use=label_names, split_batch = True,split_one_hot = True, batch_source = source)
...
# print(cnn_model.model.get_variable_names())

var_values = cnn_model.FetchAllVariableValues()
print(var_values.keys())

e = shap.DeepExplainer((cnn_model.GetLayerByName("ConvNet/reshaped_input_1"), cnn_model.GetLayerByName("ConvNet/softmax")), background)
