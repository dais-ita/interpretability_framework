...
### test the model
source = "test"
test_x, test_y = dataset_tool.GetBatch(batch_size = 10,even_examples=True, y_labels_to_use=label_names, split_batch = True,split_one_hot = True, batch_source = source)
...
import pickle
pickle.dump( var_values, open( "var_vals2.pk", "wb" ) )
