...
class InceptionResNetV2Imagenet(object):
    """InceptionResNetV2 CNN feature descriptor (trained on imagenet) with re-trained fully connected layers"""

    def __init__(self, model_input_dim_height, model_input_dim_width, model_input_channels, n_classes, model_dir,
                 additional_args={}):
        super(InceptionResNetV2Imagenet, self).__init__()
    ...
    def BuildModel(self, model_input_dim_height, model_input_dim_width, model_input_channels, n_classes,dropout): 
        ...
        base_model = InceptionResNetV2(input_tensor=vis_input, weights='imagenet',input_shape=(model_input_dim_height, model_input_dim_width, model_input_channels), include_top=False)
