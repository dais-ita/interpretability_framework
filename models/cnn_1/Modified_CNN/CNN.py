...
class SimpleCNN(object):
    ...
    def BuildModel(self, x_dict, model_input_dim_height, model_input_dim_width, model_input_channels, n_classes,
                   dropout, reuse, is_training):
    ...
    def model_fn(self, features, labels, mode):
        ...
        logits_train = self.BuildModel(features, self.model_input_dim_height, self.model_input_dim_height,
                                       self.model_input_channels, self.n_classes, self.dropout, reuse=False,
                                       is_training=True)
        logits_test = self.BuildModel(features, self.model_input_dim_height, self.model_input_dim_height,
                                      self.model_input_channels, self.n_classes, self.dropout, reuse=True,
                                      is_training=False)
