...
class LeNet(object):
    ...
    def BuildModel(self, model_input_dim_height, model_input_dim_width, model_input_channels, n_classes,dropout):
        ...
        x = Convolution2D(20, 5, 5, activation='relu')     (vis_input)
        x = MaxPooling2D((2,2), strides=(2,2))             (x)

        x = Convolution2D(50, 5, activation='relu')    (x)
        x = MaxPooling2D((2,2), strides=(2,2))             (x)
...
if __name__ == '__main__':
    ...
    cnn_model = LeNet(model_input_dim_height, model_input_dim_width, model_input_channels, n_classes,
