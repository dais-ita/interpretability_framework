...
class InceptionV3Imagenet(object):
    """Inception V3 CNN feature descriptor (trained on imagenet) with re-trained fully connected layers"""

    def __init__(self, model_input_dim_height, model_input_dim_width, model_input_channels, n_classes, model_dir,
                 additional_args={}):
        super(InceptionV3Imagenet, self).__init__()
